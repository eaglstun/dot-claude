...
related_ids:
  ...
  - "cMSY9ylTB0cZ2QpIcEqvUikNfIe5IAAL"
---
...
- **Key location:** read `TRIPO_API_KEY` from the environment or a host-managed secret
  store. Never hardcode or document a user's local credential location; if the variable is
  empty, stop and report the missing configuration.
