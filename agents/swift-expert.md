...
2. **Any `AGENTS.md` or `CLAUDE.md` and the surrounding source** — match the house idioms (naming, error types,
...
3. **The actual declarations you're touching**, not your memory of the stdlib. Swift's
   ...
   lean on it.
4. **This agent's own reference shelf: the `swift` skill** — `~/.agents/skills/swift/SKILL.md`
   is the pointer index, the pages live in `~/.agents/skills/swift/references/` —
