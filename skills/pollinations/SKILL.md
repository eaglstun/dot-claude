---
name: pollinations
description: Generate images, videos, text-to-speech audio, music, and chat/text completions using the Pollinations.AI API. Use when the user asks to create/generate an image, video clip, voiceover, speech, or music, or wants to call an LLM through Pollinations.
metadata:
  version: 1.0.0
  public: 'true'
  semantic_id: aPwFGVu6RbetOrhRNi-Xh--qZJykcAAJ
  related_ids: '["zf4FC1bnb4NbGpzCUAuA07_aIR7kUAAE","Tn5GDFfVCQUZbJD0QgYWxT-aY7ikUAAK"]'
  topic_id: v2:DNGP
