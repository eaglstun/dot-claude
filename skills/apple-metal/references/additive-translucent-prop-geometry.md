...
**Provenance:** built as a spotlight beam-shaft cone (cone geometry with a per-vertex alpha
gradient, additive blend, depth-write off) — the native Metal equivalent of Three.js
