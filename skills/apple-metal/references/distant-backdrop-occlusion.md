...
**Provenance:** learned making an always-on distant backdrop (a horizon mesa, ~30 m out) render at
all in an AR passthrough renderer that runs a LiDAR depth prepass. The failure and the fix
generalise to any far-field geometry drawn behind a real-world depth stamp.
