---
name: prisma
description: Prisma ORM reference — the schema language and data model, relations, Prisma Client querying (CRUD, filters, nested writes), transactions, raw SQL and TypedSQL, client extensions, Prisma Migrate, driver adapters, connection pooling, deployment, error codes, and query performance. Use when writing, reviewing, or debugging any schema.prisma or Prisma Client code in any repo, when a migration or P-code error comes up, or on any "how do I query X with Prisma" question.
metadata:
  version: 1.0.0
  public: 'true'
  semantic_id: q_kSIV-COfmfw96LI7ES10WalSjYIAAB
  related_ids: '["E-GAuNeSGWETws6DYrBSO0Hal4zoEAAN","M9mSK_cKHKOX6saJKoTisEWaFWCoIAAN"]'
  topic_id: v2:ELNK
...
- **[schema-and-datamodel.md](references/schema-and-datamodel.md)**
...
- **[client-crud.md](references/client-crud.md)**
...
- **[raw-sql.md](references/raw-sql.md)**
...
- **[setup-and-deploy.md](references/setup-and-deploy.md)**
...
- **[upgrade-guide.md](references/upgrade-guide.md)**
  - moving an existing project up the majors, one hop at a time: the v5 to v6
    breaking changes (Uint8Array, NotFoundError, m-n index, FTS flags) and the
    much larger v6 to v7 hop (prisma-client generator + output, mandatory driver
    adapters incl. SQLite, ESM, prisma.config.ts, driver-owned pool, CLI/env
    changes), with a full 5-to-7 checklist. _Read before bumping Prisma across a
    major version._

- **[errors-and-debugging.md](references/errors-and-debugging.md)**
