...
**The render half of that article** — tile memory, imageblocks, tile shaders, raster order
groups, A11+ MSAA sample-coverage control — is digested in
`apple-metal/references/tbdr-tile-memory-and-imageblocks.md`. Go there if you're writing a
render pass; stay here if you're writing a kernel.
