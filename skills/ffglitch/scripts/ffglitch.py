#!/usr/bin/env python3
"""Thin wrapper around locally installed FFglitch binaries (ffedit / ffgac / fflive).

Stdlib only. Resolves the binary directory from $FFGLITCH_DIR, else ~/ffglitch.
Every subcommand is a friendly front for the underlying binary and
...
DEFAULT_DIR = os.path.expanduser("~/ffglitch")
