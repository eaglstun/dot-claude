---
name: headset
description: Project reference for phone-in-headset VR using a native iOS WebView and pinned Three.js r132 without WebXR. Use for stereo rendering, head tracking, lens/IPD tuning, clicker input, motion permissions, the native shell, and project-specific API constraints.
metadata:
  version: 1.0.0
  public: 'true'
  semantic_id: VqWBJfUu8muHyBteNFiyUtH8eufYAAAB
  related_ids: '["BODE5nU53h-bmQtYcEqiUtlY-qO2AAAC","9mihB2Qg1i0L2ZoJMDiHdJF9U4vWQAAD"]'
  topic_id: v2:LBKK
